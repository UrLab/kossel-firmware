...
#define STRING_CONFIG_H_AUTHOR "Cygnus-X" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Multi Element Delta Matterialyzer"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 320.0 // mm longueur des tiges (empririque)

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 226.0 // mm distance du bed jusque cente des tiges alu (calcul precis)

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 30.4 // mm distance entre deux boules sur l'effector (calcul precis)

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 23.0 // mm distance entre centre de la boule et centre de la tige (calcul precis)

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 120 //half diametre du bed (calcul precis)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 510 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define HOMING_FEEDRATE_XYZ (10000)
#define HOMING_FEEDRATE_E 0
#define HOMING_FEEDRATE { HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_E }

// default settings
// delta speeds must be the same on xyz
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 2986}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {1000, 1000, 1000, 1000}    // (mm/sec)
